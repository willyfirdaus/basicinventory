...
<head>
    ...
    <title>Tambah Mutasi Pengeluaran</title>
    ...
    <script type="text/javascript">
           ...
           nilai2 = document.getElementById("stok_keluar").value;
...
<body>
    <h1>Tambah Mutasi pengeluaran</h1>
...
<li>
    ...
    <input type="number" name="stok_keluar" 
    id="stok_keluar" required >
</li>
...
<a href="mutasipengeluaran.php" class="btn btn-default">Kembali</a>
</ul>
