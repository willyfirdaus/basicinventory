...
$arrays = query ("SELECT * FROM requestproduksi ORDER BY id DESC");
...
<head>
    ...
    <title>Request Produksi</title>

    
</head>
<body>

<h1>Request Produksi</h1>
<a href="tambahrequestproduksi.php">Tambah Request Produksi</a>
...
<a href="requestproduksi.php"><button type="submit" name="cari">Reset</button></a>
...
<td><?=$array["job_order"];?></td>    
 ...
 <td>
     ...
     <a href="ubahrequestproduksi.php?id=<?= $array["id"]; ?>">ubah /</a>

     <!-- tag konfirmasi delete dan fungsi delete -->
     
     <a href="hapusrequestproduksi.php?id=<?= $array["id"]; ?>"  
