...
$arrays = query ("SELECT * FROM penyesuaianbarang ORDER BY id DESC");
...
<a href="tambahpenyesuaianbarang.php">Tambah penyesuaian barang</a>
...
<a href="penyesuaianbarang.php"><button type="submit" name="cari">Reset</button></a>
...
<td><?=$array["kode_penyesuaian"];?></td>    
 ...
 <td>
     ...
     <a href="ubahpenyesuaianbarang.php?id=<?= $array["id"]; ?>">ubah /</a>

     <!-- tag konfirmasi delete dan fungsi delete -->
     
     <a href="hapuspenyesuaianbarang.php?id=<?= $array["id"]; ?>"  
