...
<head>
    ...
    <title>Mutasi pengeluaran</title>

    
</head>
<body>

<h1>Mutasi pengeluaran</h1>
<a href="tambahmutasipengeluaran.php">Tambah Mutasi pengeluaran</a>
...
<a href="mutasipengeluaran.php"><button type="submit" name="cari">Reset</button></a>
...
<td><?= $i ?> </td>  
 ...
 <td>
     ...
     <a href="ubahmutasipengeluaran.php?id=<?= $array["id"]; ?>">ubah /</a>

     <!-- tag konfirmasi delete dan fungsi delete -->
     
     <a href="hapusmutasipengeluaran.php?id=<?= $array["id"]; ?>"  
