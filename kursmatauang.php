...
$arrays = query ("SELECT * FROM kursmatauang ORDER BY id DESC");
...
<a href="tambahkursmatauang.php">Tambah Gudang</a>
...
<a href="kursmatauang.php"><button type="submit" name="cari">Reset</button></a>
...
<td><?= $i ?> </td>  
 ...
 <td>
     ...
     <a href="ubahkursmatauang.php?id=<?= $array["id"]; ?>">ubah /</a>

     <!-- tag konfirmasi delete dan fungsi delete -->
     
     <a href="hapuskursmatauang.php?id=<?= $array["id"]; ?>"  
