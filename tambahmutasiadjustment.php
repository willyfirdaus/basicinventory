...
if ( isset ($_POST["submit"])) {
    ...
    if (tambah($_POST) > 0) {
        ...
        document.location.href = 'tambahmutasiadjustment.php';
        </script>
        ";
    } else {
        echo "<script>
...
<head>
    ...
    <title>Tambah Mutasi Adjustment</title>
    ...
    <script type="text/javascript">
           ...
           nilai2 = document.getElementById("penyesuaian").value;
...
<body>
    <h1>Tambah Mutasi adjustment</h1>
...
<li>
    ...
    <input type="number" name="penyesuaian" 
    id="penyesuaian" required >
</li>
